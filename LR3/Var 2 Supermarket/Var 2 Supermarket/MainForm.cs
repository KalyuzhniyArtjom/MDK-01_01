...
namespace Var_2_Supermarket
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            {
                new Product("Печенье Юбилейное", 50.50, "Юбиленое", new DateTime(2026, 3, 5), "Вкусное печенье", "C:\\repp\\LR3\\image\\Печенье.png"),
                new Product("Молочный ломтик", 75.00, "Завод киндер", new DateTime(2026, 2, 15), "Нежная вкуснятина", "C:\\repp\\LR3\\image\\Ломтик.jpg"),
                
            }
        );
            products_.Add("Напитки", new List<Product>()
            {
                new Product("Кока-Кола", 100.00, "Кока-Кола", new DateTime(2026, 4, 20), "Хорошо для праздника", "C:\\repp\\LR3\\image\\Кола.jpg"),
                new Product("Колокольчик", 45.00, "Фруто", new DateTime(2026, 2, 23), "Вкус детства", "C:\\repp\\LR3\\image\\Колокольчик.jpg"),
            }
        );
